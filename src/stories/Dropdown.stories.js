...
Primary.args = {
  ...
  SelectMaxSize: '10', // Select Dropdown Max Options to show with scroll  SelectColourBG: 'pink' // selected option bg colour, default #ccc (can be name (pink) or hex (#ccc) value)
};
